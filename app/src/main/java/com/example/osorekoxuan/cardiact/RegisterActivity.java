...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BootstrapButton mEmailSignUpButton = (BootstrapButton) findViewById(R.id.email_sign_up_button);
    ...
    private void attemptRegister() {
        ...
        // Check for a valid password varify, if the user entered one.
        if (!TextUtils.isEmpty(passwordVerify) && !isPasswordVerified(password, passwordVerify)) {
            mPasswordView.setError(getString(R.string.error_invalid_passwordVerify));
